      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            {loading ? (
              <tr>
                <td colSpan={canEditDelete ? 7 : 6} className="px-6 py-12 text-center text-sm text-gray-400">Laden...</td>
              </tr>
            ) : customers.length === 0 ? (
              <tr>
                <td colSpan={canEditDelete ? 7 : 6} className="px-6 py-12 text-center text-sm text-gray-400">Keine Kunden vorhanden</td>
              </tr>
            ) : (
              customers.map((c) => (
